...
- Número de transacciones:  1,371,980
...
- % de clientes que no han hecho ninguna compra:  0.70
...
Se observa que hay categorías con poco número de productos. Por lo que habrían categorías que no se considerarían para el modelo debido a que se harán a nivel categoría. Por ejemplo, Fun, Bags, etc.
![](./img/prodbygroup.png)

<center>
**Arctículos por mayor monto vendido**
![](./img/top10monto.png)

<center>
**Arctículos por mayor monto promedio vendido**
![](./img/top10promedio.png)

<center>
**Arctículos más vendidos de manera semanal**
![](./img/dateconteo.png)

<center>
**Arctículos por mayor monto vendido de manera semanal**
![](./img/datemonto.png)

<center>
**Arctículos por mayor monto promedio vendido de manera semanal**
![](./img/datemontopromedio.png)
